...
No installation needed to evaluate the generator — paste a spec (or load one from a URL) into the [Playground](/playground/) and generate C# code right on the page.
